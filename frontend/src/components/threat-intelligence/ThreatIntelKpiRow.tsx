import { Globe, ShieldCheck, Link2, Puzzle, Server, Radar, ArrowUpRight, ArrowDownRight } from 'lucide-react'
import type { KpiCardData } from '../../types/threatIntelligence'
...
interface ThreatIntelKpiRowProps {
  kpis: KpiCardData[]
}

export default function ThreatIntelKpiRow({ kpis }: ThreatIntelKpiRowProps) {
  return (
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <div className="p-2.5 rounded-lg bg-slate-955 text-slate-400 border border-slate-850">
