...
import type { RadarDataPoint } from '../../types/urlScanner'
...
export default function RiskRadarChart({ data }: RiskRadarChartProps) {
  const legendItems = [
    { label: 'Current URL Score', color: '#ef4444', fill: 'rgba(239, 68, 68, 0.2)' },
    { label: 'Safe URL Baseline', color: '#10b981', fill: 'transparent' }
  ]
