...
import { riskyExtensionsData } from '../../data/overviewData'
import { SEVERITY_COLORS } from '../../utils/constants'

export default function RiskyExtensions() {
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5 flex flex-col h-[340px] hover:border-slate-700 transition-colors">
      ...
      <div className="flex-1 overflow-y-auto space-y-3.5 pr-1 scrollbar-thin scrollbar-thumb-slate-800">
        {riskyExtensionsData.map((ext) => {
          const colorSet = SEVERITY_COLORS[ext.severity]
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-mono text-slate-400 tabular-nums">
                    <strong className="text-slate-250 font-bold">{ext.score}</strong>/100
                  </span>
                  {/* Badge */}
                  <span
